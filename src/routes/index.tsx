...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Quercus nábytek — nábytek na míru ve Zlíně" },
      { name: "description", content: "Vyrábíme nábytek na míru pro domácnosti, dětské pokoje, ložnice i veřejné interiéry. Prodejna Zlín, Pasecká 2374." },
    ],
  }),
  component: HomePage,
});
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        <img
          src={heroImg}
          alt="Nábytek na míru — obývací pokoj"
          width={1600}
          height={1024}
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start px-6 py-32 md:py-44">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              to="/kontakt"
              className="inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-accent-foreground shadow-soft transition-transform hover:scale-105"
            >
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-24 md:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              Praktická a stylová sestava do dětského pokoje. Maximální využití prostoru
              a odolné materiály, které vydrží.
            </p>
            ...
            <Link
              to="/sluzby"
              className="mt-10 inline-flex items-center gap-2 text-sm font-semibold text-primary hover:gap-3 transition-all"
            >
          ...
          <div className="relative">
            <img
              src={studentImg}
              alt="Sestava Student — dětský pokoj"
              loading="lazy"
              width={1200}
              height={900}
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              Ve Zlíně na ulici Pasecká 2374 máme naši prodejnu, kde nás můžete navštívit.
              Nábytek si zde můžete prohlédnout naživo a lépe si představit, jak bude vypadat.
              Při výrobě si zvolíte barevnou kombinaci i materiál. Náš personál Vám bude plně
              k dispozici. Budeme se na Vás těšit.
            </p>
            ...
            <Link
              to="/prodejna"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-card transition-transform hover:scale-105"
            >
        ...
        <div className="mx-auto max-w-7xl px-6 py-24">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              {
                img: vsbImg,
                tag: "Veřejné interiéry",
                title: "Realizace interiéru Vysoké školy báňské v Ostravě",
                text: "V únoru jsme realizovali interiér na míru na Vysoké škole báňské v Ostravě. Součástí byly rozsáhlé posluchárny.",
              },
              {
                img: bedImg,
                tag: "Bytový nábytek",
                title: "Postel pro teenagery",
                text: "Mít kvalitní prostornou postel je sen každého teenagera. Rodiče dospívajících vědí, kolik času jejich potomci tráví v posteli.",
              },
              {
                img: zrImg,
                tag: "Veřejné interiéry",
                title: "Enviromentální centrum v Železné Rudě",
                text: "Realizace interiéru enviromentálního centra v Železné Rudě z roku 2015.",
              },
            ].map((p) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="rounded-3xl bg-primary p-12 text-center text-primary-foreground shadow-soft md:p-20">
          <h2 className="font-display text-3xl font-bold md:text-5xl">
            Máte představu? Pojďme ji společně zhmotnit.
          </h2>
          ...
          <Link
            to="/kontakt"
            className="mt-10 inline-flex items-center gap-2 rounded-full bg-accent px-8 py-4 text-sm font-semibold text-accent-foreground transition-transform hover:scale-105"
          >
            Domluvit schůzku <ArrowRight size={16} />
          </Link>
        </div>
